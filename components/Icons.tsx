...
export function MicIcon({ width = 12, height = 16, color = "#424242" }: IconProps) {
  return (
...
export function WaveformIcon({ color = "#2E66F5" }: { color?: string }) {
  return (
    <Svg width="100%" height="100%" viewBox="0 0 110 34" fill="none">
...
export function StopIcon({ width = 24, height = 24, color = "#FF4B4B" }: IconProps) {
  return (
...
export function MicStartIcon({ width = 24, height = 24, color = "#2E66F5" }: IconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export function KeyboardIcon({ width = 24, height = 24, color = "#424242" }: IconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export function BackIcon({ width = 24, height = 24, color = "#424242" }: IconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export function DownloadIcon({ width = 24, height = 24, color = "#424242" }: IconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export function CheckIcon({ width = 24, height = 24, color = "#2E66F5" }: IconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export function SettingsIcon({ width = 24, height = 24, color = "#424242" }: IconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export function UserGuideIcon({ width = 36, height = 36, color = "#424242" }: IconProps) {
  return (
...
export function BrightnessIcon({ width = 24, height = 24, color = "#424242" }: IconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
...
export function FontIcon({ width = 24, height = 24, color = "#424242" }: IconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
